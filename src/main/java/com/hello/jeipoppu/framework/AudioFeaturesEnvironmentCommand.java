package com.hello.jeipoppu.framework;
 ...
 * @see Configuration
 */
public abstract class AudioFeaturesEnvironmentCommand<T extends Configuration> extends ConfiguredCommand<T> {
     ...
     */
    protected AudioFeaturesEnvironmentCommand(String name, String description) {
